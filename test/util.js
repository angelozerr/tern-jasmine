...
function createServer(defs, useCustomMatcher) {
	var plugins = {};
	plugins['jasmine'] = {};
	if (useCustomMatcher) plugins['custom_matchers'] = {};
...
exports.assertCompletion = function(text, expected, name, useCustomMatcher) {
	var defs = [];
	...
	var server = createServer(defs, useCustomMatcher);
